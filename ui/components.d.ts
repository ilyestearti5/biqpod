...
export declare const InnerWindow: ({ children, ...props }: InnerWindowProps) => JSX_2.Element;

export declare interface InnerWindowProps extends ReactElement {
}
...
export declare function TextArea({ className, multiLines, onChange, onKeyDown, onSelect, onSelectionChange, onValueChange, onFocus, onBlur, heighlight, propositions, selection, style, tabSize, supportTab, hidden, acceptKeys, pattern, ...props }: TextAreaProps): JSX_2.Element;
