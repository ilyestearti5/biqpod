...
export declare const Container: ({ children, ...props }: ContainerProps) => JSX_2.Element;

export declare interface ContainerProps extends ReactElement {
}
...
export declare const overridesForDark: Partial<Record<Biqpod.Cloud.Auth.Providers, string>>;

export declare const PDFView: () => JSX_2.Element;

export declare const PopupLayout: () => JSX_2.Element;
...
export declare const ToastItem: ({ item }: ToastItemProps) => JSX_2.Element;
