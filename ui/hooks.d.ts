...
export declare function getPosition(): Biqpod.Types.Axis | null;
...
export declare function onState<T extends object | string | number | boolean | null>(stateDir: string, comparedValue: T | ((val: T | undefined) => boolean), on?: (state: FullStateManagment) => void): Unsubscribe;
