...
class h extends m {
  async start(e) {
    return new Promise(async (s, a) => {
      ...
      const r = document.getElementById("video"), n = document.getElementById(e.parent);
      if (r)
        ...
        if (o.includes("safari") && !o.includes("chrome") && (t.setAttribute("autoplay", "true"), t.setAttribute("muted", "true"), t.setAttribute("playsinline", "true")), n.appendChild(t), !((i = navigator.mediaDevices) === null || i === void 0) && i.getUserMedia) {
          const c = {
            video: {
              width: { ideal: e.width },
  ...
  async capture(e) {
    return new Promise((s) => {
      ...
      let n;
      e.quality != null ? n = i.toDataURL("image/jpeg", e.quality / 100).replace("data:image/jpeg;base64,", "") : n = i.toDataURL("image/png").replace("data:image/png;base64,", ""), s({
        value: n
      });
    });
  }
