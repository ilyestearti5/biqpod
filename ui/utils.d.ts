...
export declare function mergeObject<T extends object | undefined = default_3.CSSProperties>(...args: (Nothing | T)[]): T;
...
export declare class Shortcut {
    ...
    static fromEvent({ key, ctrlKey: control, shiftKey: shift, altKey: alt }: default_3.KeyboardEvent<HTMLElement> | KeyboardEvent): string;
    test(e: KeyboardEvent | default_3.KeyboardEvent<HTMLElement>): boolean;
