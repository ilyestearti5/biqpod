...
import { SeparatedViewsLine, SeparatedViewsLineTitle, CircleTip, TitleView, Translate } from "@/components";
    ...
    <BlurOverlay hidden={!cameraId}>
      <SeparatedViewsLine
        ...
        list={[
          ...
          />,
          <div className={`p-2 relative overflow-hidden flex h-full items-center`}>
            <div
            ...
            >
              {canTake && <video autoPlay ref={videoElementRef} id="video-streaming" className="w-full h-full" />}
              {!canTake && (
